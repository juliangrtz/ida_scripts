"""
    decrypt_strings.py v1.1
    This is an IDA Pro script for decrypting strings inside Supercell games.

        Written by Tryso aka. Knobse,
        updated by expl0itr.

    It was tested with the following games on both Android and iOS:
        – Clash of Clans
        – Clash Royale
        – Hay Day

    Brawl Stars and Boom Beach are yet to be tested.
"""

# Because scripting inside IDA Pro can be tedious, you might want to program elsewhere, e.g. in PyCharms.
INSIDE_IDA = True  # Adjust accordingly

if INSIDE_IDA:
    import idautils
    import idc
else:
    import ida.idaapi as idaapi
    import ida.idautils as idautils
